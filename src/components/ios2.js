...
function hideAddressBar(bPad) {
	// Big window.screen. Fixed chrome likely.
	if(window.screen.width > 980 || window.screen.height > 980) return;

	// Standalone (full window.screen webapp) mode
	...
	if(bPad === true && (document.documentElement.scrollHeight <= document.documentElement.clientHeight)) {
		...
		// Viewport height at fullwindow.screen
		bodyTag.style.height = document.documentElement.clientWidth / window.screen.width * window.screen.height + 'px';
